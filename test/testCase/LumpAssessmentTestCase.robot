...
Test Template    Lump Assessment Test Case
*** Variables ***
...
Lump Assessment Nad    LumpAssessmentNad
 
Lump Assessment Nad Preview Complete    LumpAssessmentNad
   
    
# Lump Assessment Option1    LumpAssessmentCommentOption1 
...
Lump Assessment Test Case
    [Arguments]    ${testFileName}
    Log   =========== Lump Assessment Test Case===========     DEBUG    console=yes 
    ...
    Input Text    //textarea[@id='direct-report-txtbox1']   ${ultraSoundName}
