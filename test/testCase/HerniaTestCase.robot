...
Test Template    Hernia Test Case
*** Variables ***
...
AnteriorAbdominalWallAbsent    AnteriorAbdominalWallAbsent 
    
RightGrainNad    RightGrainNad
    
LeftGrainNad    LeftGrainNad
    
RightLeftGrainNad    RightLeftGrainNad
    
RightLeftGrainNaNad    RightLeftGrainNaNad
    
RightLeftGrainRoiNaNad    RightLeftGrainRoiNaNad
    
LeftGrainNad Preview Complete    LeftGrainNad
    
RightLeftGrainRoiNaNadPreviewComplete    RightLeftGrainRoiNaNad
    
AnteriorAbdominalWallAbsentPreviewComplete    AnteriorAbdominalWallAbsent
    
# Right Left Grain Comment Option1    RightLeftGrainCommentOption1
...
Hernia Test Case
    ...
    Log   =========== Hernia Test Case===========     DEBUG    console=yes 
...
NAD
    ${locator}    Set Variable    xpath=(//tr/descendant::label[./input[@type='radio' and @state='green']])
    Click NAD    ${locator}
...
Comment Options
    [Arguments]    ${option}
    ${locators}    Set Variable    xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr/descendant::label[./input[@type='radio' and @state='red']])
    ${count}    Get Element Count    ${locators}
    ${count}=     evaluate    ${count} + 1
    ...
    Log    comment entry${rowcheck}     console=yes
     ...
     FOR    ${INDEX}    IN RANGE    1   ${count}
        # Sleep    1  
        ${present}=    Run Keyword And Return Status    Element Should Be Visible     xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${INDEX}] /descendant::label[./input[@type='radio' and @state='red']])[1]
        Run keyword if    ${present}    Run keywords
        ...    Wait Until Keyword Succeeds    1 min    3 sec    Scroll Element Into View    xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${INDEX}] /descendant::label[./input[@type='radio' and @state='red']])[1] 
        ...    AND
        ...    Wait Until Keyword Succeeds    1 min    3 sec    Click Element    xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${INDEX}] /descendant::label[./input[@type='radio' and @state='red']])[1]  
        ...    AND     Capture Element Screenshot            xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${INDEX}] /descendant::label[./input[@type='radio' and @state='red']])[1] 
        # ...    Click CheckBoxes 
...
Click CheckBoxes
    ...
    ${locators}    Set Variable    xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${rowcheck}]/descendant::div[@class='details-check_hover']/label[input[@type='checkbox']])
    ${count}    Get Element Count    ${locators}
    ${count}=     evaluate    ${count} + 1
    ${elements}=    Get WebElements    ${locators}
    Log    Checkbox entry-${rowcheck}    console=yes
     FOR    ${INDEX}    IN RANGE    1   ${count}
        ...
        ${present}=    Run Keyword And Return Status    Element Should Be Visible     xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${rowcheck}]/descendant::div[@class='details-check_hover']/label[input[@type='checkbox']])[${INDEX}]
        Run keyword if    ${present}   # Run keywords
     ...
     END
    ${locators}    Set Variable    xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${rowcheck}]/descendant::div/label/following-sibling::div/descendant::label[input[@type='radio']][${option}])
    ...
    ${counter}=     evaluate    ${counter} + 1     
     FOR    ${INDEX}    IN RANGE    1   ${counter}
        ...
        ${present}=    Run Keyword And Return Status    Element Should Be Visible     xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${rowcheck}]/descendant::div/label/following-sibling::div/descendant::label[input[@type='radio']][${option}])[${INDEX}]
...
Know CheckBox Value And Click
    ...
    # ${Is_Checkbox_Selected}=    Run Keyword And Return Status    Checkbox Should Be Selected    xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${MAINROW}]/descendant::div[@class='details-check_hover']/label[input[@type='checkbox']])[${SubRow}] 
...
Click Option Under CheckBoxes
    ...
    # below iteration clicks all 1st suboption.. eg: click Normal, click Smooth,click No... etc   
     # FOR    ${INDEX}    IN RANGE    1   ${count}
    Sleep    1  
    ${present}=    Run Keyword And Return Status    Element Should Be Visible     xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${MAINROW}]/descendant::div/label/following-sibling::div/descendant::label[input[@type='radio']][${option}])[${SubOption}]
    Run keyword if    ${present}    Run keywords
    ...    Wait Until Keyword Succeeds    1 min    3 sec     Scroll Element Into View    xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${MAINROW}]/descendant::div/label/following-sibling::div/descendant::label[input[@type='radio']][${option}])[${SubOption}] 
    ...    AND
    ...    Wait Until Keyword Succeeds    1 min    3 sec     Click Element    xpath=(//tbody[10]//tr[@class='tr-toggle1']/following-sibling::tr[${MAINROW}]/descendant::div/label/following-sibling::div/descendant::label[input[@type='radio']][${option}])[${SubOption}] 
     # END
