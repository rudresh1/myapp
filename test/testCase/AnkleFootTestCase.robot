...
Test Template    AnkleFoot Test Case
*** Variables ***
...
AnkleFoot Right Side Nad    AnkleFootRightSideNad
    
AnkleFoot Left Side Nad    AnkleFootLeftSideNad
    
AnkleFoot Right Left Side Nad    AnkleFootRightLeftSideNad
    
AnkleFoot Right Side Na    AnkleFootRightSideNa
    
AnkleFoot Left Side Na    AnkleFootLeftSideNa
    
AnkleFoot Right Side Nad Roi    AnkleFootRightSideNadRoi
    
AnkleFoot Left Side Nad Roi    AnkleFootLeftSideNadRoi
    
AnkleFoot Right Left Side Nad Roi    AnkleFootRightLeftSideNadRoi
    
AnkleFoot Right Left Side Na    AnkleFootRightLeftSideNa
    
AnkleFoot All Selection Nad Roi    AnkleFootAllSelectionNadRoi
    
    
AnkleFoot Right Side Nad Preview Complete    AnkleFootRightSideNad
    
AnkleFoot Left Side Nad Preview Complete    AnkleFootLeftSideNad
    
AnkleFoot Right Left Side Nad Preview Complete    AnkleFootRightLeftSideNad
    
AnkleFoot Right Side Na Preview Complete    AnkleFootRightSideNa
    
AnkleFoot Left Side Na Preview Complete    AnkleFootLeftSideNa
    
AnkleFoot Right Side Nad Roi Preview Complete    AnkleFootRightSideNadRoi
    
AnkleFoot Left Side Nad Roi Preview Complete    AnkleFootLeftSideNadRoi
    
AnkleFoot Right Left Side Nad Roi Preview Complete    AnkleFootRightLeftSideNadRoi
    
AnkleFoot Right Left Side Na Preview Complete    AnkleFootRightLeftSideNa 
...
Side Selection
    [Arguments]    ${option}
    ${locators}    Set Variable    xpath=(//tbody[1]//tr[@class='tr-toggle1']/following-sibling::tr[8]/descendant::div[@class='details-check_hover']/label[input[@type='checkbox']])
