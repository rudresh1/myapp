...
Test Template    PaediatricHip Test Case
*** Variables ***
...
*** Test Cases ***
PaediatricHip All Nad    PaediatricHipAllNad

PaediatricHip All Na    PaediatricHipAllNa
    
PaediatricHip All Nad With Nm    PaediatricHipAllNadWithNm

PaediatricHip All Nad With Size    PaediatricHipAllNadWithSize
    
PaediatricHip All Nad With Nm Preview Complete    PaediatricHipAllNadWithNm

PaediatricHip All Nad With Size Preview Complete    PaediatricHipAllNadWithSize
...
NM
    ...
    ${locator}    Set Variable    xpath=(//tr[@class='tr-toggle1']/following-sibling::tr/descendant::div//label[input[@type='checkbox' and (@id='degreeNm' or @id='onlyformNm')]])
...
Enter Size
     ${locators}    Set Variable    xpath=(//tr[@class='tr-toggle1']/following-sibling::tr/descendant::div/descendant::input[@type='text'])  
     ${count}    Get Element Count    ${locators}
     ${count}=     evaluate    ${count} + 1
     ${elements}=    Get WebElements    ${locators}
     ...
     FOR    ${INDEX}    IN RANGE    1   ${count}
        ${size}      Generate random string    2    0123456789
        ${present}=    Run Keyword And Return Status    Element Should Be Visible    xpath=(//tr[@class='tr-toggle1']/following-sibling::tr/descendant::div/descendant::input[@type='text'])[${INDEX}]
        Run keyword if    ${present}    Run keywords
        ...    Scroll Element Into View    xpath=(//tr[@class='tr-toggle1']/following-sibling::tr/descendant::div/descendant::input[@type='text'])[${INDEX}]    AND
        ...    Input Text    (//tr[@class='tr-toggle1']/following-sibling::tr/descendant::div/descendant::input[@type='text'])[${INDEX}]    ${size}
     END    
