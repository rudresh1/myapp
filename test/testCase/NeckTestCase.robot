...
*** Test Cases ***
All Field NA    NeckAllNa

All Field Nad    NeckAllNad

All Field Nad And Size    NeckAllNadWithSize
    
All Field Nad and NM      NeckAllNadWithNm
    
All Field Nad NM and ROI    NeckAllNadWithNmRoi
    
All Field Nad Size and ROI    NeckAllNadWithSizeRoi
    
All Field NA Preview Complete    NeckAllNa
    
All Field Nad And Size Preview Complete    NeckAllNadWithSize
    
All Field Nad and NM Preview Complete      NeckAllNadWithNm
    
All Field Nad NM and ROI Preview Complete    NeckAllNadWithNmRoi
    
All Field Nad Size and ROI Preview Complete    NeckAllNadWithSizeRoi
...
# To fill side selection if there  
    # FOR    ${key}    IN    @{member['keyList']}
        # Log    ${key}    console=yes
