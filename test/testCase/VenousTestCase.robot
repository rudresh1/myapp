...
Test Template    Venous Test Case
*** Variables ***
...
Venous Right Side Nad    VenousRightSideNad
    
Venous Left Side Nad    VenousLeftSideNad
    
Venous Right Left Side Nad    VenousRightLeftSideNad
    
Venous Right Side Na    VenousRightSideNa
    
Venous Left Side Na    VenousLeftSideNa
    
Venous Right Side Nad Roi    VenousRightSideNadRoi
    
Venous Left Side Nad Roi    VenousLeftSideNadRoi
    
Venous Right Left Side Nad Roi    VenousRightLeftSideNadRoi
    
Venous Right Left Side Na    VenousRightLeftSideNa
    




Venous Right Side Nad Preview Complete    VenousRightSideNad
    
Venous Left Side Nad Preview Complete    VenousLeftSideNad
    
Venous Right Left Side Nad Preview Complete    VenousRightLeftSideNad
    
Venous Right Side Na Preview Complete    VenousRightSideNa
    
Venous Left Side Na Preview Complete    VenousLeftSideNa
    
Venous Right Side Nad Roi Preview Complete    VenousRightSideNadRoi
    
Venous Left Side Nad Roi Preview Complete    VenousLeftSideNadRoi
    
Venous Right Left Side Nad Roi Preview Complete    VenousRightLeftSideNadRoi
    
Venous Right Left Side Na Preview Complete    VenousRightLeftSideNa    
...
Venous Test Case
    ...
    Log   =========== Venous Test Case===========     DEBUG    console=yes 
