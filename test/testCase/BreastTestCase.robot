...
Test Template    Breast Test Case
*** Variables ***
...
Breast Right Side Nad    BreastRightSideNad
    
Breast Left Side Nad    BreastLeftSideNad
    
Breast Right Left Side Nad    BreastRightLeftSideNad
    
Breast Right Side Na    BreastRightSideNa
    
Breast Left Side Na    BreastLeftSideNa
    
Breast Right Left Side Na    BreastRightLeftSideNa
    
Breast Right Side Na Preview Complete   BreastRightSideNa
    
Breast Right Left Side Nad Preview Complete    BreastRightLeftSideNad

        
Breast Right Left Side Na Preview Complete    BreastRightLeftSideNa
    
# Breast Right Left Side Comment Option1    BreastRightLeftSideCommentOption1
