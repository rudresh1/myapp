...
Test Template    Arterial Test Case
*** Variables ***
...
Arterial Right Side Nad    ArterialRightSideNad
    
Arterial Left Side Nad    ArterialLeftSideNad
    
Arterial Right Left Side Nad    ArterialRightLeftSideNad
    
Arterial Right Side Na    ArterialRightSideNa
    
Arterial Left Side Na    ArterialLeftSideNa
    
Arterial Right Side Nad Roi    ArterialRightSideNadRoi
    
Arterial Left Side Nad Roi    ArterialLeftSideNadRoi
    
Arterial Right Left Side Nad Roi    ArterialRightLeftSideNadRoi
    
Arterial Right Left Side Na    ArterialRightLeftSideNa
    




Arterial Right Side Nad Preview Complete    ArterialRightSideNad
    
Arterial Left Side Nad Preview Complete    ArterialLeftSideNad
    
Arterial Right Left Side Nad Preview Complete    ArterialRightLeftSideNad
    
Arterial Right Side Na Preview Complete    ArterialRightSideNa
    
Arterial Left Side Na Preview Complete    ArterialLeftSideNa
    
Arterial Right Side Nad Roi Preview Complete    ArterialRightSideNadRoi
    
Arterial Left Side Nad Roi Preview Complete    ArterialLeftSideNadRoi
    
Arterial Right Left Side Nad Roi Preview Complete    ArterialRightLeftSideNadRoi
    
Arterial Right Left Side Na Preview Complete    ArterialRightLeftSideNa    
...
Side Selection
    [Arguments]    ${option}
    Log    inside Side selection      console=yes  
