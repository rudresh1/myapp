...
Test Template    Obstrectics Test Case
*** Variables ***
...
All Field Nad    ObstrecticsAllNad

All Field Nad Preview Complete    ObstrecticsAllNad
    
All Field Comment    ObstrecticsAllComment 
    
All Field Comment Preview Complete    ObstrecticsAllComment   

*** Keywords ***

Obstrectics Test Case

    [Arguments]    ${testFileName}    ${credentials}=${None}
    Log   =========== Obstrectics Test Case===========     DEBUG    console=yes
