...
*** Test Cases ***
All Field NA    PelvisAllNa

All Field Nad    PelvisAllNad    credentials

All Field Nad And Size    PelvisAllNadWithSize    credentials
    
All Field Nad and NM      PelvisAllNadWithNm
    
All Field Nad NM and ROI    PelvisAllNadWithNmRoi
    
All Field Nad Size and ROI    PelvisAllNadWithSizeRoi

AllFieldNadSizeandROIPreviewComplete    PelvisAllNadWithSizeRoi
    
AllFieldNadNMandROIPreviewComplete    PelvisAllNadWithNmRoi        
...
# Renal Test Case
    ...
    # Fill Clinical Hx In Pelvis    ${member['clinicalHx']}  
    
    # Fill Findings in Pelvis    ${member['findings']} 
